...
try:
    ...
    key_from = 'FROM'
    default_email = "vaibhav.mehra.in@gmail.com"  # Replace with your desired default email
    default_start_date = "20-Feb-2025"  # Replace with your desirWed start date
    default_end_date = "21-Feb-2025"  # Replace with your desired end date
    
    sender_email = input(f"Enter sender's email address [{default_email}]: ") or default_email
    start_date = input(f"Enter start date (DD-MMM-YYYY format) [{default_start_date}]: ") or default_start_date
    end_date = input(f"Enter end date (DD-MMM-YYYY format) [{default_end_date}]: ") or default_end_date
